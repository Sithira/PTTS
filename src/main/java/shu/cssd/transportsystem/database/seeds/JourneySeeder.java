...
public class JourneySeeder implements BaseSeeder
{
    ...
    public void seed()
    {
        Journey journey1 = new Journey(users[0], routes[0], stop[0], stop[6],135D);
        Journey journey2 = new Journey(users[1], routes[1], stop[2], stop[6],175D);
        Journey journey3 = new Journey(users[2], routes[2],stop[2], stop[8],50D);
        Journey journey4 = new Journey(users[3],routes[3], stop[1], stop[8],300D);
        Journey journey5 = new Journey(users[3],routes[4], stop[0], stop[3],250D);
        Journey journey6 = new Journey(users[3],routes[4], stop[3], stop[0],250D);
