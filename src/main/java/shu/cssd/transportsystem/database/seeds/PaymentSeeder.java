...
public class PaymentSeeder implements BaseSeeder
{
	...
	public void seed()
	{
		...
		SmartCard smartCard1 = new SmartCard("1", 1111, 111, date1);
		SmartCard smartCard2 = new SmartCard("2", 2222, 222, date2);
		SmartCard smartCard3 = new SmartCard("3", 3333, 333, date2);
		SmartCard smartCard4 = new SmartCard("4", 4444, 444, date2);
	...
	public void read()
	{
		...
		for (BaseModel model : this.setOfSmartCards.all())
		{
			...
			System.out.println("ExpDate: " + smartCard.expiryDate);
		}
	}
