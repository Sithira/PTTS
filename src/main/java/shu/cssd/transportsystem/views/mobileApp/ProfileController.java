...
public class ProfileController implements Initializable
{
	...
	public void initialize(URL location, ResourceBundle resources)
	{
		...
		this.name.setText(UserController.currentUser.name);
		this.phone.setText(UserController.currentUser.postalCode);
		this.address.setText(UserController.currentUser.address);
