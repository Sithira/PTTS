...
public class RoutesController {
    ...
    private void addButtonClick(MouseEvent event) throws IOException {
        Parent addParent = FXMLLoader.load(getClass().getResource("/admin/addRoute/addRoute.fxml"));
    ...
    private void modButtonClick(MouseEvent event) throws IOException {
        Parent modParent = FXMLLoader.load(getClass().getResource("/admin/modifyRoute/modifyRoute.fxml"));
